...
//var_dump($assignment_post_id);		
	...
	*/
	...
	{
	    global $wpdb;
		$wpdb->sp_assignment_submissions = $wpdb->prefix . 'sp_assignment_submissions';
		//var_dump($wpdb->sp_assignment_submissions);
		...
		if (empty( $db_version )) {
			...
			$sqlQuery = "
			CREATE TABLE " . $wpdb->sp_assignment_submissions . " (
...
// Adding Custom Database for Assignments and Submissions
add_action('init', array('SPAssignment', 'sp_dbSetup'), 0);
